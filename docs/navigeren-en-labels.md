...
Bezoekers van jouw website hebben een beeld in het hoofd van hoe een website werkt en wat knoppen en iconen doen. 
Dat heet een _Mental model_, iedereen heeft dat, jij ook, een idee van wat we denken te weten over een systeem en hoe het werkt.
